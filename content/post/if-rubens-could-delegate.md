---
title: "If Rubens could delegate his paintings, why can't you delegate your code?"
...
I have previously argued that [engineers using agentic coding should think like managers](/post/ics-using-genai-should-think-like-managers/). But perhaps you are not interested in management. You don't know what managers do and don't want to learn to think like them. You are put off by all the manager-analogies and wish they'd stop. Perhaps you are the artistic type, who thinks of themselves as a software craftsperson.
...
Let's review this process again. The artist receives a commission. They create a high level plan of what the composition would look like. They would create a quick sketch, or an MVP, and get it approved. Then they would decide how to execute the actual painting. They would break down the tasks and assign them to their team of assistants. They would meticulously review the work and provide final touches. So a painting would be conceptualized but only partially painted by Rubens, yet still credited to him.
